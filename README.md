...
See [CONTEXT.md](./CONTEXT.md), [docs/design.md](./docs/design.md), and [docs/adr/0001-runtime-does-not-wrap-facets.md](./docs/adr/0001-runtime-does-not-wrap-facets.md).
